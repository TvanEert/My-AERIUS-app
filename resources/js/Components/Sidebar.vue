...
<template>
    ...
    <div class="flex absolute pt-16 pl-8 top-0 h-full w-[80%] bg-aerius-lightblue ease-in duration-300 translate-x-[-100%] opacity-75" id="sidebar">
        <ul>
            ...
            <template v-if="situations.length > 0">
                ...
                <li v-for="index in situations" class="font-bold text-white text-2xl mb-5">
